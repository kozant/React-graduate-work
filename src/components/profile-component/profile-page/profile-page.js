...
import { getAuthorArticles, getFavouritedArticles } from '../../../services/article-service';
...
class ProfilePage extends Component {
	...
	render() {
		...
		const anotherProfile = (
			<FollowProfile author={authorData.username} following={authorData.following} token={token} />
		);

		const profileButton = author === username && !loadingPage && !errorPage ? yourProfile : anotherProfile;
